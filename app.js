...
let heroArr = [
  { name: "Andrew", alive: true, curHealth: 100, maxHealth: 100, attack: 10, level: 0 },
  { name: "Hayden", alive: true, curHealth: 120, maxHealth: 120, attack: 8, level: 0 },
  { name: "Scott", alive: true, curHealth: 60, maxHealth: 60, attack: 15, level: 0 },
]
...
if (heroArr.length - 1 > 0) {
  setInterval(dealHeroDamage, 1000)
} else {
}
